...
export const Footer = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-between md:justify-around gap-2 bg-sky-500 mt-2 py-4 md:text-xl xl:text-2xl font-bold">
      <div className="flex items-center">
        <img
          ...
          alt="icon"
        />
        <p className="ml-2 font-bold md:text-xl xl:text-5xl animate-pulse text-gradient-argentina">
          Mytinerary
        </p>
      </div>
